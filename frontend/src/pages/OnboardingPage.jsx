    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="w-9 h-9 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 hover:border-gray-300
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="px-8 py-5 border-b border-gray-100 bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900 tracking-tight">FocusFlow</span>
        </div>
      </header>
        ...
        <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 shadow-sm p-10">
          ...
          {step === 1 && (
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-1">Set your Pomodoro rhythm</h2>
          ...
          {step === 2 && (
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-1">Customize your workspace</h2>
              <p className="text-gray-500 text-sm mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-sm font-medium text-gray-700 mb-3">Appearance</p>
                  <div className="grid grid-cols-2 gap-3">
                    {['light', 'dark'].map(theme => (
                      ...
                      >
                        ...
                        <span className="text-xs font-medium text-gray-700 capitalize">{theme}</span>
                        {prefs.theme === theme && (
          ...
          {step === 3 && (
            <div className="text-center">
              ...
              <div className="bg-gray-50 rounded-xl p-5 text-left space-y-2 mb-8">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-3">Your settings</p>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Focus session</span>
                  <span className="font-medium text-gray-800">{prefs.pomodoro_duration} min</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Short break</span>
                  <span className="font-medium text-gray-800">{prefs.short_break} min</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Long break</span>
                  <span className="font-medium text-gray-800">{prefs.long_break} min</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Theme</span>
                  <span className="font-medium text-gray-800 capitalize">{prefs.theme}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Timezone</span>
                  <span className="font-medium text-gray-800">{prefs.timezone.replace(/_/g, ' ')}</span>
                </div>
              </div>

              {error && (
                <div className="mb-5 text-sm text-red-600 bg-red-50 border border-red-100 px-4 py-3 rounded-lg text-left">
                  {error}
                </div>
              )}
              ...
              <div className="flex gap-3">
                <button
                  onClick={back}
                  disabled={submitting}
                  className="flex-1 border border-gray-200 text-gray-600 hover:bg-gray-50 font-medium py-2.5 rounded-lg text-sm transition-colors disabled:opacity-50"
                >
                  Back
                </button>
                <button
